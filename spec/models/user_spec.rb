...
describe User do
  ...
  describe "when name is toooooo damn long!" do
  ...
  describe "when pw not present" do
    before {@user.password = @user.password_confirmation = ""}
    it {should_not be_valid}
  end
  
  describe "when pw doesn't match confirm" do
    before {@user.password_confirmation = "mismatch"}
    it {should_not be_valid}
  end
  
  describe "when pw confirm is nil" do
    before {@user.password_confirmation = nil}
    it {should_not be_valid}
  end
  
  describe "pw is too shor" do
